package vu.de.signalerror.blinken.raspberry.impl;
...
public class RaspberryBlinkenViewerImpl implements BlinkenViewer
{

	private static Logger logger = Logger.getLogger(RaspberryBlinkenViewerImpl.class);
	...
	public RaspberryBlinkenViewerImpl()
	{
